class GetDealerUserDetailsResModel {
    GetDealerUserDetailsResModel({
        required this.id,
    ...
    factory GetDealerUserDetailsResModel.fromJson(Map<String, dynamic> json){ 
        return GetDealerUserDetailsResModel(
            id: json["id"],
