class UpdateReceiptUrlResModel {
  UpdateReceiptUrlResModel({
    required this.id,
  ...
  factory UpdateReceiptUrlResModel.fromJson(Map<String, dynamic> json) {
    return UpdateReceiptUrlResModel(
      id: json["id"],
