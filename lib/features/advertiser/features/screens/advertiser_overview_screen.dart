                                    ...
                                    child: RecentAdsTile(
                                      ...
                                      onTap: () {
                                        WidgetsBinding.instance
                                          ...
                                          ref
                                              .read(titleStateProvider.notifier)
                                              .state = advert.title ?? '';
                                          ref
                                              .read(descriptionStateProvider
                                                  .notifier)
                                              .state = advert.description ?? '';
                                          ref
                                              .read(
                                                  statusStateProvider.notifier)
                                              .state = advert.status ?? '';
                                          ref
                                          ...
                                          ref
                                              .read(
                                                  targetStateProvider.notifier)
                                              .state = advert.targetUrl ?? '';
                                          ref
                                              .read(
                                                  budgetStateProvider.notifier)
                                              .state = advert.budget.toString();
                                          ref
                                                  .read(
                                                      calltoActionStateProvider
                                                          .notifier)
                                                  .state =
                                          ...
                                          ref
                                                  .read(dateCreatedStateProvider
                                                      .notifier)
                                                  .state =
                                              advert.dateCreated.toString();
                                          ref
                                                  .read(contentUrlStateProvider
                                                      .notifier)
                                                  .state =
                                              advert.displayContentUrl ?? '';
                                          ref
                                              .read(typeStateProvider.notifier)
                                              .state = advert.type ?? '';
                                          ref
                                              .read(sizeStateProvider.notifier)
                                              .state = advert.size ?? '';
                                          ref
                                              .read(
                                                  screenStateProvider.notifier)
                                              .state = advert.screens ?? '';
                                          ref
                                              .read(
                                                  deviceStateProvider.notifier)
                                              .state = advert.deviceType ?? '';
                                          ref
                                              .read(
